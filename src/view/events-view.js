...
<div class="event">
  ...
  <div class="event__schedule">
    <p class="event__time">
      <time class="event__start-time" datetime="2019-03-18T10:30">${item.startTime}</time>
      &mdash;
      <time class="event__end-time" datetime="2019-03-18T11:00">${item.endTime}</time>
    </p>
